                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    @include('adviser.modals.add-company')
                                    <h4></h4>
                                    <button type="button" class="btn btn-success block" data-toggle="modal" data-target="#add-company" title="Add company">
                                        ...
                                        <table class='table table-striped' id="table1">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th colspan="1" width=250>Update/Remove</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @if ($moa->isNotEmpty())
                                                    @foreach ($moa as $moa)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @include('adviser.modals.edit-company')
                                                                <button type="button" class="btn btn-primary block" data-toggle="modal" data-target="#update-company{{ $moa->company_id }}">
                                                                    Update
                                                                </button>   
                                                                @include('adviser.modals.remove-company')
                                                                <button type="button" class="btn btn-danger block" data-toggle="modal" data-target="#remove-company{{ $moa->company_id }}">
                                                                    Remove
                                                                </button>   
                                                            </td>
                                                        </tr>
