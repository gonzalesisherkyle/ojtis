                                ...
                                <div class="card-body px-3 pb-5">
                                    <form method="POST" action="{{ route('change-password') }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="new_password" type="password" class="form-control" name="new_password" autocomplete="new-password" minlength="8" alphabet="A-Za-z0-9+_%@!$*~-" required>
                                                <i id="toggle_pwd2" style="color: black" class="fa fa-fw fa-eye-slash errspan"></i>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="new_confirm_password" type="password" class="form-control" name="new_confirm_password" autocomplete="new-confirm-password" required> 
                                                <i id="toggle_pwd3" style="color: black" class="fa fa-fw fa-eye-slash errspan"></i>
                                            </div>
                                        </div>
