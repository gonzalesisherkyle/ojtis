                                ...
                                <div class="card-body px-3 pb-5">
                                    <form method="POST" action="{{ route('change-password') }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="new_password" type="password" class="form-control @error('new_password') is-invalid @enderror" name="new_password" autocomplete="current-password" minlength="8" alphabet="A-Za-z0-9+_%@!$*~-" required>
