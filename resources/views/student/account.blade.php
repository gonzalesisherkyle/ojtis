                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <strong class="text" style="color:red">*</strong>
                                                    <input type="text" id="student_number" name="student_number" value="{{ $user->student_number }}" class="form-control @error('student_number') is-invalid @enderror" autocomplete="student_number" placeholder="2019-00000-TG-0" pattern="[0-9]{4}-[0-9]{5}-[A-Z]{2}-[0]{1}" required>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="course_id" id="course_id" class="form-select @error('course_id') is-invalid @enderror">
                                                        @foreach (\App\Models\Course::all() as $course)
                                                            <option value="{{ $course->course_id }}" @if ($course->course_id == $user->course_id)
                                                                selected
                                                            @endif >
                                            ...
                                            <div class="col-lg-3 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <strong class="text" style="color:red">*</strong>
                                                    <input type="text" id="year_and_section" name="year_and_section" value="{{ $user->year_and_section }}" class="form-control @error('year_and_section') is-invalid @enderror" autocomplete="year_and_section" pattern="[0-5]{1}-[0-9]{1}" placeholder="4-1" required>
